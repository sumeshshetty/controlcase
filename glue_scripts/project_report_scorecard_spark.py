...
destination_table = 'test_project_scorecard_report'
...
datasink1 = glueContext.write_dynamic_frame.from_jdbc_conf(frame = dyf, catalog_connection = "acc_dev_db", connection_options = {"dbtable": "test_project_scorecard_report", "database": "acc_dev_db"}, transformation_ctx = "datasink1")
